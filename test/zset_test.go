...
func TestZAddConflictingOptions(t *testing.T) {
	...
	assert.Equal(t, protocol.RespGTLTNXNotCompatible, resp)
...
func TestZRangeByLexWithScores(t *testing.T) {
	...
	assert.Equal(t, protocol.RespWithScoresNotSupportedByLex, resp)
}
...
func TestZRangeInvalidScoreRange(t *testing.T) {
	...
	assert.Equal(t, protocol.RespMinOrMaxNotFloat, resp)
}
