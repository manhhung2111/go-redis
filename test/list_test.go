...
func TestLPushX_InvalidArity(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			expected := core.EncodeResp(util.InvalidNumberOfArgs("LPUSHX"), false)
...
func TestLPushX_SingleElement(t *testing.T) {
	...
	rangeVal, _, err := core.DecodeResp(rangeResp)
	require.NoError(t, err)
...
func TestLRem_InvalidArity(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			expected := core.EncodeResp(util.InvalidNumberOfArgs("LREM"), false)
			assert.Equal(t, expected, resp)
		})
	}
}
...
func TestLSet_InvalidArity(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			expected := core.EncodeResp(util.InvalidNumberOfArgs("LSET"), false)
			assert.Equal(t, expected, resp)
		})
	}
}
...
func TestLTrim_InvalidArity(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			expected := core.EncodeResp(util.InvalidNumberOfArgs("LTRIM"), false)
			assert.Equal(t, expected, resp)
		})
	}
}
...
func TestRPushX_InvalidArity(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			expected := core.EncodeResp(util.InvalidNumberOfArgs("RPUSHX"), false)
			assert.Equal(t, expected, resp)
		})
	}
}
