...
func TestGeoAddInvalidLatitude(t *testing.T) {
	...
	assert.Equal(t, protocol.RespValueNotValidFloat, resp)
}
...
func TestGeoAddInvalidCoordinates(t *testing.T) {
	...
	assert.Equal(t, protocol.RespInvalidLongitudeLatitude, resp)
...
func TestGeoAddNXXXConflict(t *testing.T) {
	...
	assert.Equal(t, protocol.RespXXNXNotCompatible, resp)
}
...
func TestGeoSearchMissingFrom(t *testing.T) {
	...
	assert.Equal(t, protocol.RespGeoFromMemberOrFromLonLatReq, resp)
}
...
func TestGeoSearchMissingBy(t *testing.T) {
	...
	assert.Equal(t, protocol.RespGeoByRadiusOrByBoxReq, resp)
}
